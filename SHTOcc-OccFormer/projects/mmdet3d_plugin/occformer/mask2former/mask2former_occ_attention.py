...
class Mask2FormerOccHead(MaskFormerHead):
    ...
    def loss_single(self, cls_scores, mask_preds, gt_labels_list,
                    gt_masks_list, img_metas,tail_class=[2,3,4,5,6,7,8,12,14,16,18,19]):
    ...
    def TailVoxelSampler(self, voxel_feat, prev_indices,M, target_classes=[2,3,4,5,6,7,8,12,14,16,18,19]):
        """
        Args:
