...
def _make_pretrained_clip_vitl16_384(
    ...
    clip_pretrained, _ = clip.load("/ailab/user/wangxuhong/yuqiucheng/Symphonies/ckpts/ViT-B-32.pt", device='cuda', jit=False)
    model = timm.create_model("vit_large_patch16_384", pretrained=pretrained,pretrained_cfg_overlay=dict(file='/ailab/user/wangxuhong/yuqiucheng/Symphonies/ckpts/pytorch_model.bin', custom_load=False))
