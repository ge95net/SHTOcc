...
from projects.mmdet3d_plugin.utils.nusc import nusc_class_frequencies
...
class SparseMask2FormerOpenOccHead(MaskFormerHead):
    ...
    def __init__(self,
        ...
        kitti_class_weights = 1 / np.log(nusc_class_frequencies)
    ...
    def forward_head(self, 
        ...
        nonempty_pred = torch.einsum('bqc, bnc -> bqn', mask_embed, mask_feature.unsqueeze(0))
        ...
        mask_3d = mask_3d.repeat((1, 
                                  ...
                                  ori_size[2], 
                                  1))  # B, W, H, D, Q
        mask_3d = rearrange(mask_3d, 'b h w z q -> b q (h w z)')
    ...
    def forward(self, 
        ...
        nonempty_prob = 1 - F.softmax(coarse_occ_, dim=0)[..., 0]  # [B, N]
        ...
        print('nonempty_indices=',nonempty_indices.shape)
        ...
        cls_pred, mask_pred, attn_mask = self.forward_head(query_feat, 
                    nonempty_feats, multi_scale_memorys[0].shape[-3:], nonempty_indices, voxel_feats[0].shape[-3:])
        ...
        return cls_pred_list, mask_pred_list, coarse_occ
