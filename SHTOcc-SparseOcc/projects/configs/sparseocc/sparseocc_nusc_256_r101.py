...
empty_idx = 0
visible_mask = False
#resume_from = 'work_dirs/sparseocc_nusc_256/best_nuScenes_SSC_mIoU_epoch_18.pth'


phase = 'stage_1'  # stage_1 or stage_2

if phase == 'stage_1':
    load_from = 'ckpts/r101_dcn_fcos3d_pretrain.pth'
else:
    load_from = 'work_dirs/occformer_nusc_r101_896x1600/best_nuScenes_lidarseg_mean_epoch_22.pth'
...
model = dict(
    type='SparseOcc',
    img_backbone=dict(
        pretrained='ckpts/r101_dcn_fcos3d_pretrain.pth',
        type='ResNet',
        depth=50,
        num_stages=4,
        out_indices=(0, 1, 2, 3),
    ...
    optimizer = dict(
        ...
        paramwise_cfg=dict(
            custom_keys={
                ...
                'cls_embed': dict(lr_mult=1, decay_mult=1),
            },
            norm_decay_mult=0.0))
